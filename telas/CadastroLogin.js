...
export default function Login(props) {
    ...
    const capturaEmail=(email)=> {
        setEmail(email)
    };
    const capturaCnpj=(cnpj)=> {
        setCnpj(cnpj)
    }
    const capturaCpf=(cpf)=> {
        setCpf(cpf)
    };
    const capturaSenha=(senha)=> {
        setSenha(senha)
    }
